...
- I kept the helper functions small and modular in utils.c to avoid clutter and make them easier to manage.

- I centralized all error messages and exit handling in errors.c to avoid repeating myself.
