...
EXECUTION =	execution/builtins/cd.c execution/builtins/pwd.c execution/builtins/echo.c execution/builtins/exit.c \
			execution/builtins/unset.c execution/builtins/export.c execution/builtins/export_utils.c execution/builtins/env.c \
			execution/environment/fill_env_list.c execution/environment/free_env_list.c execution/environment/get_env_arr.c \
			execution/events/puterror_to_exit.c execution/events/puterror.c execution/events/errno_manager.c execution/events/display_intro.c \
			execution/garbage_collector/free_all_tracked.c execution/garbage_collector/nalloc.c execution/utilities/ft_arrlen.c \
			execution/utilities/ft_atoi.c execution/utilities/ft_isallchar.c execution/utilities/ft_isdigit.c execution/utilities/ft_memset.c \
